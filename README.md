...
For a given method a, the Relative Improvement of CORAL-Net over method a when selecting the same number of features is defined as**Relative Improvement** = ((Performance of CORAL-Net − Performance of method *a*) / Performance of method *a*) × 100%
